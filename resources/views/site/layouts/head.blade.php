<head>
    ...
    <link rel="stylesheet" href="{{ surl('vendor/owl/owl.carousel.css') }}" />

    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.css" />
    <link rel="stylesheet" href="{{ surl('vendor/wizard/wizard.css') }}" />
    <link rel="stylesheet" href="{{ surl('vendor/aos/animate.css') }}" />
    <link rel="stylesheet" href="{{ surl('vendor/aos/aos.css') }}" />
    <link rel="stylesheet" href="{{ surl('vendor/select2/select2.min.css') }}" />
